  ...
  compileCards() {
    ...
    for(let j = 0; j < this.jokers.length; j++) {
      ...
      switch(joker[JOKER]) {
        ...
        case 21:
          // Banner
          this.compiledChips += joker[VALUE] * 40;
          break;
        case 27:
          // Steel Joker
          if(this.hasVampire) {
        ...
        case 103:
          // Runner
          if(this.hasStraight) {
            this.compiledChips += 30 + 10 * joker[VALUE];
          }
          else {
            this.compiledChips += 20 + 10 * joker[VALUE];
          }
          break;
        case 104:
          // Ice Cream
        ...
        case 119:
          ...
          if(this.cards.length === 4) {
            this.compiledChips += 20 + 4 * joker[VALUE];
          }
          else {
            this.compiledChips += 16 + 4 * joker[VALUE];
          }
          break;
        case 122:
          // Vampire
