...
const jokerTexts = [
  ...
  [
    ...
    ['Banner', '${chipc}+30${endc} Chips for<br>each remaining<br>${numc}discard${endc}<br>${shadowc}(Currently ${chipc}+${jokerValue * 30}${endc} Chips)${endc}'],
    ...
    ['Steel Joker', 'This Joker gains ${prodc}0.2${endc} Mult<br>for each ${numc}Steel Card${endc}<br>in your full deck<br>${shadowc}(Currently ${prodc}${1 + jokerValue * 0.2}${endc} Mult)${endc}'],
  ...
  [
    ...
    ['Glass Joker', 'This Joker gains ${prodc}0.75${endc} Mult<br>for every ${numc}Glass Card${endc}<br>that is destroyed<br>${shadowc}(Currently ${prodc}${1 + jokerValue * 0.75}${endc} Mult)${endc}'],
  ...
  [
    ['Wee Joker', 'This Joker gains<br>${chipc}+8${endc} Chips when each<br>played ${numc}2${endc} is scored<br>${shadowc}(Currently ${chipc}+${jokerValue * 8}${endc} Chips)${endc}'],
  ...
  [
    ...
    ['Hit the Road', 'This Joker gains ${prodc}0.5${endc} Mult<br>for every ${numc}Jack${endc}<br>discarded this round<br>${shadowc}(Currently ${prodc}${1 + jokerValue * 0.5}${endc})${endc}'],
  ...
  [
    ...
    ['Ride the Bus', 'This Joker gains ${multc}+1${endc} Mult<br>per consecutive hand<br>played without a<br>scoring ${numc}face${endc} card<br>${shadowc}(Currently ${multc}+${jokerValue}${endc})${endc}'],
  ...
  [
    ...
    ['Invisible Joker', 'After 2 rounds,<br>sell this card to<br>${numc}duplicate${endc} a random Joker<br>${shadowc}(Currently ${numc}${jokerValue}${endc}/2)${endc}'],
  ...
  [
    ...
    ['Caino', 'This Joker gains ${prodc}1${endc} Mult<br>when a ${numc}face${endc} card<br>is destroyed<br>${shadowc}(Currently ${prodc}${1 + jokerValue}${endc} Mult)${endc}'],
    ['Triboulet', 'Played ${numc}Kings${endc} and<br>${numc}Queens${endc} each give<br>${prodc}2${endc} Mult when scored'],
    ['Yorick', 'This Joker gains<br>${prodc}1${endc} Mult every ${numc}23${endc} ${shadowc}[23]${endc}<br>cards discarded<br>${shadowc}(Currently ${prodc}${1 + jokerValue}${endc} Mult)${endc}'],
  ...
  [
    ...
    ['Runner', 'Gains ${chipc}+15${endc} Chips<br>if played hand<br>contains a ${numc}Straight${endc}<br>${shadowc}(Currently ${chipc}+${jokerValue * 15}${endc} Chips)${endc}'],
    ['Ice Cream', '${chipc}${jokerValue > 20 ? "" : "+"}${Math.max(0, 100 - jokerValue * 5)}${endc} Chips<br>${chipc}-5${endc} Chips for<br>every hand played'],
    ...
    ['Constellation', 'This Joker gains<br>${prodc}0.1${endc} Mult every time<br>a ${planetc} card is used<br>${shadowc}(Currently ${prodc}${(10 + jokerValue)/10}${endc} Mult)${endc}']
  ],
  [
    ...
    ['To Do List', 'Earn ${moneyc}$4${endc} if ${numc}poker hand${endc}<br>is a ${numc}Pair${endc},<br>poker hand changes<br>at end of round'],
    ...
    ['Red Card', 'This Joker gains<br>${multc}+3${endc} Mult when any<br>${numc}Booster Pack${endc} is skipped<br>${shadowc}(Currently ${multc}+${jokerValue * 3}${endc} Mult)${endc}'],
    ['Madness', 'When ${numc}Small Blind${endc} or ${numc}Big Blind${endc}<br>is selected, gain ${prodc}0.5${endc} Mult<br>and ${numc}destroy${endc} a random Joker<br>${shadowc}(Currently ${prodc}${1 + jokerValue * 0.5}${endc})${endc}'],
    ['Square Joker', 'This Joker gains ${chipc}+4${endc} Chips<br>if played hand has<br>exactly ${numc}4${endc} cards<br>${shadowc}(Currently ${chipc}+${jokerValue * 4}${endc} Chips)${endc}']
  ],
  [
    ...
    ['Vampire', 'This Joker gains ${prodc}0.1${endc} Mult<br>per scoring ${numc}Enhanced card${endc} played,<br>removes card ${numc}Enhancement${endc}<br>${shadowc}(Currently ${prodc}${(10 + jokerValue) / 10}${endc} Mult)${endc}'],
    ['Shortcut', 'Allows ${numc}Straights${endc} to be<br>made with gaps of ${numc}1 rank${endc}<br>${shadowc}(ex: ${numc}10 8 6 5 3${endc})${endc}'],
    ['Hologram', 'This Joker gains ${prodc}0.25${endc} Mult<br>every time a ${numc}playing card${endc}<br>is added to your deck<br>${shadowc}(Currently ${prodc}${1 + jokerValue * 0.25}${endc} Mult)${endc}'],
    ...
    ['Obelisk', 'This Joker gains ${prodc}0.2${endc} Mult<br>per consecutive hand played<br>without playing your<br>most played ${numc}poker hand${endc}<br>${shadowc}(Currently ${prodc}${(10 + jokerValue * 2) / 10}${endc} Mult)${endc}']
  ],
  [
  ...
  [
    ...
    ['Lucky Cat', 'This Joker gains ${prodc}0.25${endc} Mult every<br>time a ${numc}Lucky${endc} card<br>${probc}successfully${endc} triggers<br>${shadowc}(Currently ${prodc}${(10 + jokerValue * 2.5) / 10}${endc} Mult)${endc}'],
  ...
  [
    ['Flash Card', 'This Joker gains ${multc}+2${endc} Mult<br>per ${numc}reroll${endc} in the shop<br>${shadowc}(Currently ${multc}+${jokerValue * 2}${endc} Mult)${endc}'],
    ...
    ['Spare Trousers', 'This Joker gains ${multc}+2${endc} Mult<br>if played hand contains<br>a ${numc}Two Pair${endc}<br>${shadowc}(Currently ${multc}+${jokerValue * 2}${endc} Mult)${endc}'],
    ['Campfire', 'This Joker gains ${prodc}0.25${endc} Mult<br>for each card ${numc}sold${endc}, resets<br>when ${numc}Boss Blind${endc} is defeated<br>${shadowc}(Currently ${prodc}${1 + jokerValue * 0.25}${endc} Mult)${endc}'],
